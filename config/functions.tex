...
% 智能驾驶相关车载感知：后续模型适配与应用研究方向。
\newcommand{\DrivingExtensionDirection}{智能驾驶相关车载感知}
\newcommand{\DrivingPilotTask}{驾驶员状态监测}
\newcommand{\DrivingPilotStates}{困倦、分心}
\newcommand{\DrivingPilotOutput}{带时间戳的状态标签与事件记录}
